...
import { FiSettings, FiCpu, FiShield, FiTrendingUp, FiHelpCircle, FiFileText } from 'react-icons/fi';
...
type TabTypes = 'general' | 'models' | 'firewall' | 'rules' | 'analytics' | 'help';

const TABS: { id: TabTypes; icon: React.ComponentType<{ className?: string }>; label: string }[] = [
  { id: 'general', icon: FiSettings, label: t('options_tabs_general') },
  { id: 'models', icon: FiCpu, label: t('options_tabs_models') },
  { id: 'firewall', icon: FiShield, label: t('options_tabs_firewall') },
  { id: 'rules', icon: FiFileText, label: t('options_tabs_rules') },
...
const Options = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'rules':
        return <RuleSettings isDarkMode={isDarkMode} />;
      case 'analytics':
